                        ...
                        <div class="">
                         <img src="{{ asset('images/finallogo.png') }}" alt="Violation Photo" class="w-16 h-16">
                          ...
                          <div class="text-center mt-2">
                             <label for="" class="font-black text-white text-xl " id="logo">DASS</label>
                          </div>
                     </div>
                </a>
                {{-- <li>
                 ...
                 <li>
                    <a href="{{ route('addsurvey') }}"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
